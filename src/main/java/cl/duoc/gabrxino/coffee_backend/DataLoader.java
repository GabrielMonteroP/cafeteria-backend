...
public class DataLoader implements CommandLineRunner {
    ...
    private void cargarCafes() {
        ...
        crear("Latte Macchiato", "Leche manchada con espresso", 2900, "CAFE", "https://assets.tmecosys.com/image/upload/t_web_rdp_recipe_584x480_1_5x/img/recipe/ras/Assets/314D11A6-4457-4C70-A1BE-A6C25F597C18/Derivates/B362DC69-6AAA-43E1-AF51-184463E8551B.jpg");
        crear("Mocaccino", "Café, leche y salsa de chocolate", 3400, "CAFE", "https://www.cafescandelas.com/uploads/media_items/mocaccino-500.500.500.s.jpg");
        ...
        crear("Caramel Macchiato", "Vainilla, leche, espresso y caramelo", 3600, "CAFE", "https://dinnerthendessert.com/wp-content/uploads/2023/10/Caramel-Macchiato-10.jpg");
        crear("Café Irlandés", "Con un toque de whisky y crema", 4500, "CAFE", "https://cdn.recetasderechupete.com/wp-content/uploads/2021/03/Irish-coffee-2.jpg");
        crear("Affogato", "Espresso sobre helado de vainilla", 3800, "CAFE", "https://static01.nyt.com/images/2021/08/15/magazine/affogato/affogato-mediumSquareAt3X-v2.jpg");
        crear("Chai Latte", "Té especiado con leche cremosa", 3100, "CAFE", "https://carorocco.com/wp-content/uploads/2021/03/Te-Chai-Latte-CUERPO.jpg");
        crear("Dirty Chai", "Chai Latte con un shot de espresso", 3500, "CAFE", "https://midwestniceblog.com/wp-content/uploads/2022/09/homemade-dirty-chai-latte-recipe.jpg");
    }

    private void cargarPasteleria() {
        crear("Medialuna", "Clásica, dulce y mantecosa", 1200, "PASTELERIA", "https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=500");
        ...
        crear("Croissant Almendras", "Relleno de crema de almendras", 2400, "PASTELERIA", "https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=500");
        ...
        crear("Galletón de Avena", "Saludable, con pasas y miel", 1500, "PASTELERIA", "https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=500");
        crear("Galletón ChocoChips", "Estilo americano, borde crujiente", 1600, "PASTELERIA", "https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=500");
    ...
    private void cargarBebidasFrias() {
        crear("Iced Coffee", "Café negro con hielo", 2500, "FRIO", "https://cdn.loveandlemons.com/wp-content/uploads/2025/05/how-to-make-iced-coffee-at-home.jpg");
        crear("Iced Latte", "Latte frío servido en capas", 3000, "FRIO", "https://cdn.loveandlemons.com/wp-content/uploads/2025/05/how-to-make-iced-coffee-at-home.jpg");
        crear("Cold Brew", "Infusión en frío por 12 horas", 3200, "FRIO", "https://lifesimplified.gorenje.com/wp-content/uploads/2024/06/gorenje-blog-refreshing_cold_brew_coffee-1040x585.jpg");
        crear("Frappuccino Café", "Granizado de café con crema", 3800, "FRIO", "https://simplyhomecooked.com/wp-content/uploads/2025/07/caramel-frappuccino-recipe-2.jpg");
        crear("Frappuccino Moka", "Granizado con chocolate", 4000, "FRIO", "https://simplyhomecooked.com/wp-content/uploads/2025/07/caramel-frappuccino-recipe-2.jpg");
        crear("Frappuccino Caramelo", "El favorito, muy dulce", 4000, "FRIO", "https://simplyhomecooked.com/wp-content/uploads/2025/07/caramel-frappuccino-recipe-2.jpg");
        ...
        crear("Agua Mineral", "Con o sin gas", 1500, "FRIO", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAmASyPCeCGrZo7uKnbGbpnT4p6J5c89BrYA&s");
